#!/usr/bin/env python3
"""
Dwarkesh Patel Podcast パイプライン
=====================================
使い方:
  # 記事生成のみ
  python pipelines/dwarkesh.py https://www.youtube.com/watch?v=VIDEO_ID

  # 記事生成 + homupe ブログ投稿
  python pipelines/dwarkesh.py https://www.youtube.com/watch?v=VIDEO_ID --publish

  # X (Twitter) にも投稿
  python pipelines/dwarkesh.py https://www.youtube.com/watch?v=VIDEO_ID --publish --tweet

  # Pass 2 から再実行（section_summaries.json 再利用）
  python pipelines/dwarkesh.py https://www.youtube.com/watch?v=VIDEO_ID --regen
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Dwarkesh Patel Podcast → 日本語翻訳記事 パイプライン",
